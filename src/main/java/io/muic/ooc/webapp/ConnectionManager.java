...
//    private final String jdbcURL;
    ...
    private String databaseURL = "jdbc:mysql://localhost:3306/login";
    private String databaseUsername = "fonytas";
    private String databasePassword = "fonytas";
...
//            Class.forName(jdbcDriverStr);
            ...
            String query = "INSERT INTO login.user (username, password, firstname, lastname, status) VALUES(?,?,?,?,?)";
